  ...
  <main class="relative isolate">
    ...
    <div class="px-6 pt-14 lg:px-8">
      <div class="mx-auto max-w-2xl pt-24 text-center sm:pt-40">
        <h2 class="text-4xl font-bold tracking-tight text-white sm:text-6xl">Event Booking</h2>
      ...
      <div class="mx-auto max-w-2xl lg:mx-0 lg:max-w-none">
        ...
        >
          ...
          <div>
            <p>
              ...
              id dignissim eget. Est augue maecenas risus nulla ultrices congue nunc tortor. Enim et
        ...
        >
          <div class="flex flex-col-reverse gap-y-3 border-l border-white/20 pl-6">
            <dt class="text-base leading-7 text-gray-300">Seats Booked</dt>
            <dd class="text-3xl font-semibold tracking-tight text-white">1000+</dd>
          </div>
          <div class="flex flex-col-reverse gap-y-3 border-l border-white/20 pl-6">
    ...
    <div class="mx-auto mt-32 max-w-7xl px-6 sm:mt-40 lg:px-8">
      ...
      >
        ...
        <div class="relative pl-9">
          ...
          <dd class="inline">
            Iure sed ab. Aperiam optio placeat dolor facere. Officiis pariatur eveniet atque et
            dolor.
          </dd>
        </div>
        <div class="relative pl-9">
    ...
    <div class="mx-auto mt-32 max-w-7xl px-6 sm:mt-40 lg:px-8">
      <div class="mx-auto max-w-2xl lg:mx-0">
        ...
        <p class="mt-6 text-lg leading-8 text-gray-300">
          Excepturi repudiandae alias ut. Totam aut facilis. Praesentium in neque vel omnis. Eos
          error odio. Qui fugit voluptatibus eum culpa.
        </p>
      </div>
      <ul
        role="list"
